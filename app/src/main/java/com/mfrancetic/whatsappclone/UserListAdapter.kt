...
class UserListAdapter(private val context: Context, private val userEmails: MutableList<String>) :
    RecyclerView.Adapter<UserListAdapter.ViewHolder>() {

    class ViewHolder(private val context: Context, itemView: View) : RecyclerView.ViewHolder(itemView), View.OnClickListener {
